...
class ProductView(View):
    def get(self, request):
        ...
        print("Laptop Count:", laptops.count())
...
def topwear(request, data=None):
    ...
    if data == None:
        topwears = Product.objects.filter(category='TW')  # TW = Topwear
    elif data == 'below':
        topwears = Product.objects.filter(category='TW').filter(discounted_price__lt=1000)  # Example price
    elif data == 'above':
...
def bottomwear(request, data=None):
    ...
    if data == None:
        bottomwears = Product.objects.filter(category='BW')  # BW = Bottomwear
    elif data == 'below':
...
def search(request):
    ...
    print("Query:", query)
    print("Results Count:", products.count())
